...
<div class="btn-toolbar list-toolbar">
    ...
    <form class="form-inline">
        ...
        <% } else { %>
            ...
            <p class="stat"><span class="label label-info"><%=usersService.detectedRecords.size()%></span> Detected records</p>
            <h2> </h2>
...
<table class="table">
  ...
  <%  List detectedRecords = usersService.detectedRecords;
      for(int i = 0; i < detectedRecords.size(); i++) {
      List tmpList = usersService.tableDataMap.get( detectedRecords.get(i) );
  %>
      <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-danger" data-dismiss="modal" type="submit">Удалить</button>
        </div>
      </div>
    </div>
</div>
